...
public class MeterReadingController {
    ...
    public ResponseEntity<ApiResponse<MeterReadingResponseDTO>> create(
            @Valid @RequestBody CreateMeterReadingDTO dto) {

        MeterReadingResponseDTO response = service.create(dto);
    ...
    public ResponseEntity<ApiResponse<Page<MeterReadingResponseDTO>>> search(
        ...
        Page<MeterReadingResponseDTO> response = service.search(supplyId, status, startDate, endDate, pageable);
